...
latex_documents = [
    (master_doc, 'Unipress.tex', 'Unipress Documentation',
     'jgrynczewski', 'manual'),
]
...
man_pages = [
    (master_doc, 'unipress', 'Unipress Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Unipress', 'Unipress Documentation',
     author, 'Unipress', 'One-button games collection built with Python and Arcade.',
     'Miscellaneous'),
]
